...
assert_contains "$(run_cadence '' 25)" 'OVERDUE (>25); insert a Check-in STEP now.'
...
assert_contains "$(run_cadence '<!-- CHECK-IN-CADENCE: 50 -->' 55)" 'OVERDUE (>55); insert a Check-in STEP now.'
...
assert_contains "$(run_cadence '<!-- CHECK-IN-CADENCE: 15 -->' 20)" 'OVERDUE (>20); insert a Check-in STEP now.'
