...
| Local user profile | `.throughstone/local-user.md` | Per-machine settings for the active contributor: experience level sets the background assumed, communication style sets how much *why* comes with it. |
