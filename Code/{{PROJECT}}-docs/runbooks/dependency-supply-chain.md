...
- [ ] **Scan for known vulnerabilities.** Run the matching audit on **every package manifest in
      every repo you can reach** — and name any you can't, so a partial sweep reads as partial
