...
| [`release-deploy.md`](release-deploy.md) | Ship a version safely: rollback plan **before** deploy, reversible migrations, a watch window, one clear lever back. | Operational; whenever you ship/roll back — *"run the release."* | `architecture/*-infrastructure-deployment.md`, `*-environments.md` |
