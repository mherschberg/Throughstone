...
|---------|--------------------|---------------|-------------|
| [`check-in.md`](check-in.md) | Doc-drift reconciliation (both directions), accepted risk/debt review, and a full test run — the periodic "is the project still healthy?" gate. | A **STEP**, roughly every 10–20 STEPs; *"run the check-in."* | `METHOD.md` §5 (*Check-in STEPs*); `AGENTS.md`; `registries/risks.yml` |
