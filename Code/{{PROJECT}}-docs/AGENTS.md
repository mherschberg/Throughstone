...
- **Keep accepted risks visible.** Known, accepted risks and deferred technical debt live in
  ...
  report under `Code/{{PROJECT}}-docs/reports/incidents/`, or check-in report under
  `Code/{{PROJECT}}-docs/reports/` that carries the details; create that source first if it
  doesn't exist.
